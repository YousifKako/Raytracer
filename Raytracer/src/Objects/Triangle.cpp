...
void
Triangle::set_vertices(const Vector3D<double>& x1,
...
void
Triangle::set_vertices_rgb(const Vector3D<double>& x1,
                                const Vector3D<double>& x2,
                                const Vector3D<double>& x3)
{
...
void
Triangle::set_vertices_rgb(double x1, double x2, double x3)
{
    this->normals.change_vars(x1, x2, x3);
}

void
Triangle::set_normals(const Vector3D<double>& normals)
{
